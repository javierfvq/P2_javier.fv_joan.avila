...
public class LoadFiles {
    ...
    private static final String FILE_PATH_INTERNS = "files/PAED-2425-P2-Datasets/interns.paed";
    private static final String FILE_PATH_TASKS   = "files/PAED-2425-P2-Datasets/tasks.paed";

    // private static final String FILE_PATH_INTERNS = "src/files/PAED-2425-P2-Datasets/internsExtraSmall.paed";
    // private static final String FILE_PATH_TASKS   = "src/files/PAED-2425-P2-Datasets/tasksExtraSmall.paed";
